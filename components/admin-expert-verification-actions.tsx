...
import type { AdminExpertVerificationActionState } from "@/app/admin/expert-verifications/actions";
import {
  adminApproveExpertVerification,
  adminRejectExpertVerification,
...
export function AdminExpertVerificationActions({ userId }: Props) {
  const t = useTranslations("adminExpertVerifications.detail.actions");
