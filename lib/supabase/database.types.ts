...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      listing_category_unchanged_for_owner: {
      ...
      subscriptions_enforcement_enabled: { Args: never; Returns: boolean }
    ...
    Enums: {
      ...
      listing_status: "active" | "sold" | "rented" | "pending" | "paused"
