...
CREATE TABLE public.rfq_drafts (
...
CREATE INDEX rfq_items_draft_id_idx ON public.rfq_items (draft_id);
...
CREATE INDEX rfq_attachments_draft_id_idx ON public.rfq_attachments (draft_id);
CREATE INDEX rfq_attachments_uploaded_by_idx ON public.rfq_attachments (uploaded_by);
